...
const socialLinks = [
  { name: "Facebook", icon: Facebook, href: "https://facebook.com/ninajeanmaintenance" },
  { name: "Instagram", icon: Instagram, href: "https://www.instagram.com/ninajeanmaintenance" },
  { name: "Google", icon: Search, href: "https://share.google/rBKcglAOvM8HAE1GE" },
  { name: "LinkedIn", icon: Linkedin, href: "https://linkedin.com/in/ninajeanmaintenance" },
  {
    name: "WhatsApp",
    icon: () => (
      <svg
